...
//"assets/jss/material-kit-pro-react/components/headerLinksStyle.js";
            ...
            <ListItem className={classes.listItem}>
                <CustomDropdown
                    ...
                    dropdownList={[
                        ...
                        >
                            <Icon className={classes.dropdownIcons}>
                                content_paste
                            </Icon>
                            Documentation
                        </a>
                ...
                <CustomDropdown
                    ...
                    dropdownList={[
                        ...
                        <Link to='/blog-posts' className={classes.dropdownLink}>
                            <ViewQuilt className={classes.dropdownIcons} /> Blog
                            Posts
                        </Link>,
                        ...
                        <Link to='/pricing' className={classes.dropdownLink}>
                            <AttachMoney className={classes.dropdownIcons} />{" "}
                            Pricing Page
                        </Link>,
                        <Link
                        ...
                        <Link to='/error-page' className={classes.dropdownLink}>
                            <Error className={classes.dropdownIcons} /> Error
                            Page
                        </Link>
                    ]}
                />
